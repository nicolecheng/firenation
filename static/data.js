...
var add_node = function(list, element) {
  ...
  node.innerHTML = train_name + ' train from ' + list[2] + '. <span class="label label-default">' + (Math.round(list[1] * 100)/100).toString() + ' mi away <span class="glyphicon glyphicon-road"></span></span> ';
